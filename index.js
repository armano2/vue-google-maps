 ...
 * ```
 */
var load = function load(apiKey, version, libraries, loadCn) {
...
var eventsBinder = (function (vueElement, googleMapObject, events) {
  _forEach(events, function (eventName) {
...
var propsBinder = (function (vueElement, googleMapsElement, props, options) {
  options = options || {};
...
var getPropsValuesMixin = {
  methods: {
    getPropsValues: function getPropsValues() {
      var _this = this;

      return _mapValues(this.$options.props, function (v, k) {
        return _this[k];
      });
    }
  }
...
var Marker = {
  ...
  deferredReady: function deferredReady() {
    ...
    var options = _mapValues(props, function (value, prop) {
      return _this[prop];
    });
...
var Polyline = {
  ...
  deferredReady: function deferredReady() {
    ...
    propsBinder(this, this.$polylineObject, _omit(props$1, ['deepWatch', 'path']));
    eventsBinder(this, this.$polylineObject, events$1);
...
var events$2 = ['click', 'dblclick', 'drag', 'dragend', 'dragstart', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'];
...
var Polygon = {
  ...
  deferredReady: function deferredReady() {
    ...
    propsBinder(this, this.$polygonObject, _omit(props$2, ['path', 'paths', 'deepWatch']));
    eventsBinder(this, this.$polygonObject, events$2);
...
var events$3 = ['click', 'dblclick', 'drag', 'dragend', 'dragstart', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'];
...
var Circle = {
  ...
  methods: {
    createCircle: function createCircle(options) {
      ...
      var boundProps = _clone(props$3);
      delete boundProps.bounds;
      propsBinder(this, this.$circleObject, boundProps);
      eventsBinder(this, this.$circleObject, events$3);
...
var events$4 = ['click', 'dblclick', 'drag', 'dragend', 'dragstart', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'];
...
var Rectangle = {
  ...
  methods: {
    createRectangle: function createRectangle(options) {
      ...
      propsBinder(this, this.$rectangleObject, props$4);
      eventsBinder(this, this.$rectangleObject, events$4);
    }
  },
...
var events$5 = ['domready', 'closeclick', 'content_changed'];

var InfoWindow = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [_c('div', { ref: "flyaway" }, [_vm._t("default")], 2)]);
  }, staticRenderFns: [],
  ...
  methods: {
    ...
    createInfoWindow: function createInfoWindow() {
      ...
      // Binding
      propsBinder(this, this.$infoWindow, _omit(props$5, ['opened']));
      eventsBinder(this, this.$infoWindow, events$5);
...
var events$6 = ['click', 'dblclick', 'drag', 'dragend', 'dragstart', 'idle', 'mousemove', 'mouseout', 'mouseover', 'resize', 'rightclick', 'tilesloaded'];
...
var Map = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vue-map-container" }, [_c('div', { ref: "vue-map", staticClass: "vue-map" }), _vm._v(" "), _c('div', { staticClass: "vue-map-hidden" }, [_vm._t("default")], 2), _vm._v(" "), _vm._t("visible")], 2);
  }, staticRenderFns: [],
  mixins: [getPropsValuesMixin, DeferredReadyMixin, mountableMixin],
  props: props$6,
  ...
  deferredReady: function deferredReady() {
    ...
    return loaded.then(function () {
      ...
      // creating the map
      var copiedData = _clone(_this2.getPropsValues());
      delete copiedData.options;
      var options = _clone(_this2.options);
      Object.assign(options, copiedData);
      _this2.$mapObject = new google.maps.Map(element, options);

      // binding properties (two and one way)
      propsBinder(_this2, _this2.$mapObject, _omit(props$6, ['center', 'zoom', 'bounds']));

      // manually trigger center and zoom
      _this2.$mapObject.addListener('center_changed', function () {
        if (_this2.$listeners && _this2.$listeners.center_changed) {
          _this2.$emit('center_changed', _this2.$mapObject.getCenter());
        }
      });

      _this2.$mapObject.addListener('zoom_changed', function () {
        if (_this2.$listeners && _this2.$listeners.zoom_changed) {
          _this2.$emit('zoom_changed', _this2.$mapObject.getZoom());
        }
      });

      _this2.$mapObject.addListener('bounds_changed', function () {
        if (_this2.$listeners && _this2.$listeners.bounds_changed) {
          _this2.$emit('bounds_changed', _this2.$mapObject.getBounds());
        }
      });

      //binding events
      eventsBinder(_this2, _this2.$mapObject, events$6);
...
var downArrowSimulator = (function (input) {
...
var PlaceInput = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('label', [_c('span', { domProps: { "textContent": _vm._s(_vm.label) } }), _vm._v(" "), _c('input', { ref: "input", class: _vm.className, attrs: { "type": "text", "placeholder": _vm.placeholder } })]);
  }, staticRenderFns: [],
  ...
  mounted: function mounted() {
    ...
    loaded.then(function () {
      ...
      propsBinder(_this, _this.autoCompleter, _omit(props$7, ['placeholder', 'place', 'selectFirstOnEnter', 'defaultPlace', 'className', 'label']));
...
var Autocomplete = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('input', { ref: "input", attrs: { "type": "text", "placeholder": _vm.placeholder }, domProps: { "value": _vm.value } });
  }, staticRenderFns: [],
  mixins: [getPropsValuesMixin],
  ...
  mounted: function mounted() {
    ...
    loaded.then(function () {
      ...
      var finalOptions = _pickBy(Object.assign({}, _omit(options, ['options', 'selectFirstOnEnter', 'value', 'place', 'placeholder']), options.options), function (v, k) {
        return v !== undefined;
      });
      ...
      propsBinder(_this, _this.$autocomplete, _omit(props$8, ['placeholder', 'place', 'selectFirstOnEnter', 'value', 'componentRestrictions']));
...
exports.MapElementMixin = MapElementMixin;
exports.Autocomplete = Autocomplete;
exports.MountableMixin = mountableMixin;
